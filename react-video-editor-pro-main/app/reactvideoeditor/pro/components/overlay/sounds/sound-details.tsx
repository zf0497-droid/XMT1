        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 rounded-md bg-card p-4 border">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-extralight text-foreground">{t.audio.volume}</h3>
              <Toggle
                ...
                className="text-xs"
              >
                {(localOverlay?.styles?.volume ?? 1) === 0 ? t.video.unmute : t.video.mute}
              </Toggle>
            </div>
          ...
          <div className="space-y-4 rounded-md bg-card p-4 border">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-extralight text-foreground">{t.audio.fadeIn}</h3>
          ...
          <div className="space-y-4 rounded-md bg-card p-4 border">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-extralight text-foreground">{t.audio.fadeOut}</h3>
              <span className="text-xs text-muted-foreground">
