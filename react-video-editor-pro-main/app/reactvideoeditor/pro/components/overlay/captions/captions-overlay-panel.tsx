            ...
            <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div className="flex flex-col items-center font-extralight">
                    <span className="text-foreground">
                      {isProcessing ? t.captions.processingSRT : t.captions.uploadSRT}
                    </span>
                    <span className="text-xs text-muted-foreground mt-1">
                      {t.captions.srtFormat}
                    </span>
                  </div>
                </Button>
                <input
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-extralight text-foreground">{t.captions.generateFromText}</span>
                </div>
                <Textarea
                  value={script}
                  onChange={(e) => setScript(e.target.value)}
                  placeholder={t.captions.scriptPlaceholder}
                  rows={8}
