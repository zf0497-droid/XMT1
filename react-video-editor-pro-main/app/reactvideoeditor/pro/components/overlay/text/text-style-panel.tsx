...
/**
 * Get localized font weight label
 */
const getFontWeightLabel = (value: string): string => {
  const labels: Record<string, string> = {
    "100": t.text.thin,
    "200": t.text.extraLight,
    "300": t.text.light,
    "400": t.text.regular,
    "500": t.text.medium,
    "600": t.text.semiBold,
    "700": t.text.bold,
    "800": t.text.extraBold,
    "900": t.text.black,
  };
  ...
  return (
    ...
    <div className="space-y-2">
      ...
      <div className="space-y-4 rounded-md bg-sidebar p-2.5 border">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className="w-full px-3 py-2 text-xs text-left text-foreground bg-background border rounded-md hover:bg-accent hover:text-accent-foreground">
                  {localOverlay.styles.fontFamily || t.text.selectFont}
                </button>
              </PopoverTrigger>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="w-full text-xs text-foreground">
                <SelectValue className="text-foreground" placeholder={t.text.selectWeight} />
              </SelectTrigger>
              <SelectContent>
                {fontWeights
                  ...
                  .map((weight) => (
                    ...
                    >
                      {getFontWeightLabel(weight.value)}
                    </SelectItem>
                  ))}
              </SelectContent>
            </Select>
            ...
            <div className="flex items-center gap-2">
              {showFontSizeReset && (
                <Tooltip>
                  ...
                  <TooltipContent side="top">{t.text.resetFontSize}</TooltipContent>
                </Tooltip>
              )}
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              {showLetterSpacingReset && (
                <Tooltip>
                  ...
                  <TooltipContent side="top">{t.text.resetLetterSpacing}</TooltipContent>
                </Tooltip>
              )}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-4">
            <label className="text-xs text-muted-foreground/50">{t.text.alignment}</label>
            <ToggleGroup
              type="single"
              size="sm"
      ...
      <div className="space-y-2 rounded-md bg-sidebar p-2.5 border">
        <h5 className="text-sm font-light leading-none text-foreground">{t.text.colors}</h5>
