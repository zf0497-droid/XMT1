  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-sm font-extralight">{t.uploads.myUploads}</h2>
        <div>
          <Button
            variant="default"
            size="sm"
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="h-full flex flex-col font-extralight items-center justify-center py-8 text-muted-foreground text-center">
              ...
              <p className="text-sm text-center">{t.tips.noMediaSelected}</p>
