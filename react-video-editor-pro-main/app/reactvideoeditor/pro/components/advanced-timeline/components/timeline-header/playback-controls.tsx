        ...
        <TooltipProvider delayDuration={50}>
          <Tooltip>
            ...
            <TooltipContent
              ...
              align="center"
            >
              <span className="text-foreground">{t.timeline.jumpToStart}</span>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      )}
          ...
          >
            <div className="flex items-center gap-1">
              <span className="text-foreground">
                {isPlaying ? t.timeline.pauseVideo : t.timeline.playVideo}
              </span>
            </div>
          </TooltipContent>
        </Tooltip>
        ...
        <TooltipProvider delayDuration={50}>
          <Tooltip>
            ...
            <TooltipContent
              ...
              align="center"
            >
              <span className="text-foreground">{t.timeline.jumpToEnd}</span>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      )}
