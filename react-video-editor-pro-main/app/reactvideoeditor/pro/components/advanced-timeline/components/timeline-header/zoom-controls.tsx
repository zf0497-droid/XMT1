      ...
      <TooltipProvider delayDuration={50}>
        <Tooltip>
          ...
          <TooltipContent
            ...
            align="center"
          >
            <span className="text-gray-700 dark:text-zinc-200">{t.timeline.zoomOut}</span>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      ...
      <TooltipProvider delayDuration={50}>
        <Tooltip>
          ...
          <TooltipContent
            ...
            align="center"
          >
            <span className="text-gray-700 dark:text-zinc-200">{t.timeline.zoomIn}</span>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
      ...
      <TooltipProvider delayDuration={50}>
        <Tooltip>
          ...
          <TooltipContent
            ...
            align="center"
          >
            <span className="text-gray-700 dark:text-zinc-200">{t.timeline.fitToScreen}</span>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    </div>
