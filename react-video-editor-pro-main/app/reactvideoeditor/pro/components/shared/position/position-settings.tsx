      ...
      <div className="border rounded-md overflow-hidden bg-card">
        <CollapsibleTrigger className="w-full flex justify-between items-center px-4 py-3 bg-card hover:bg-accent/50 duration-200 ease-out">
          <div className="flex items-center gap-2">
            <span className="font-extralight text-xs text-foreground  ">{t.position.position}</span>
          </div>
          <svg
            width="16"
            height="16"
        ...
        <CollapsibleContent>
          <div className="p-3 bg-card border-t">
            ...
            <Button
              ...
              title={t.position.fillCanvas}
            >
              <span className="text-xs text-foreground">{t.position.fillCanvas}</span>
            </Button>
          </div>
        </CollapsibleContent>
      </div>
